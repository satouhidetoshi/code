...
function write_site_title() {
	...
	?>
	<
	<<?php echo esc_attr( $title_tag ); ?> class="site-title text-sm vertival-rl"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></<?php echo esc_attr( $title_tag ); ?>>
	<?php
}
endif;
